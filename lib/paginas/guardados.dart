...
class guardados extends StatefulWidget {
  const guardados({Key? key}) : super(key: key);
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (_) => detalle(vini: favouriteitems[index])))
            .then((value) {
          setState(() {});
        });
      },
